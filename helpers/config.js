const mongoUrl = 'mongodb://penny:boostersA123@49.50.67.44:27017/digidoc?authSource=admin'; 	// Mongo DB URL for Node maintained data
const host='http://49.50.67.44';				// URL for Angular code (Entity) [RedirectURL]
const port='2018';								// Port on which Node instance is running
